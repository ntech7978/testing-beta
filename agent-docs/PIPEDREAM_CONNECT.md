...
This scopes every connected account to the specific {{CHANNEL_NAME}} channel (workspace +
...
- **Status page** — project ID, environment, external_user_id, {{CHANNEL_NAME}} identity
